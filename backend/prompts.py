...
_ROUTE = (
    " 0–{t1}s EXTERIOR ONLY: Medium-wide shot of the main capsule in the "
    "{scene_en}, door open with warm 3500K light spilling out. Secondary "
    "capsules scattered in the background. Slow push-in or slight lateral dolly "
    "toward the door; do not enter yet. "
    "{t1}–{t2}s ENTRY: Walk through the door without stopping. The door frame "
    "should cross naturally past the lens edges; no cut, no dissolve, no "
    "morphing. "
